...
function is31Flavors(totalFlavors){
    if(totalFlavors.length === 31){
        return true;
    }
    else{
        return false;
...
function addFlavor(orginalList,newFlavor){
    orginalList.unshift(newFlavor);
    return orginalList;
}
...
*/
function removeLastFlavor(arr,removeItem){
    arr.pop(removeItem);
    return arr;
 }
